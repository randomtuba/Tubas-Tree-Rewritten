...
function getPointGen() {
  ...
  if(gain.gte(1e25)) gain = gain.pow(hasUpgrade("p",25) ? 0.55 : 0.5).mul(new Decimal(1e25).pow(hasUpgrade("p",25) ? 0.55 : 0.5))
